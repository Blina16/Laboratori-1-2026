    ...
    <section class="bg-gradient-to-br from-blue-600 to-indigo-700 text-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div class="text-center">
          <h1 class="text-4xl font-bold mb-4">About TutorRemote</h1>
          <p class="text-xl text-blue-100 max-w-3xl mx-auto">
            Empowering students worldwide through innovative online tutoring
          </p>
        </div>
      </div>
    </section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="bg-blue-50 rounded-xl p-8">
            <div class="grid grid-cols-2 gap-6">
              ...
              <div class="text-center">
                <div class="text-3xl font-bold text-orange-600 mb-2">1M+</div>
                <div class="text-gray-600">Hours Taught</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <p class="text-gray-600 mb-4">Head of Tutoring</p>
            <p class="text-gray-600 text-sm">
              Ensures quality and excellence across our global tutor network.
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="py-20 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">
          Whether you're looking to learn or teach, become part of the TutorRemote family today.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <router-link to="/signup" class="btn-primary bg-white text-blue-600 hover:bg-gray-100 px-8 py-4 text-lg font-semibold">
            Start Learning
          </router-link>
          <router-link to="/admin-signup" class="btn-secondary border-2 border-white text-white hover:bg-white hover:text-blue-600 px-8 py-4 text-lg font-semibold">
            Become a Tutor
          </router-link>
        </div>
      </div>
