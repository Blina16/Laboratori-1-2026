// Complete integration test for courses CRUD operations
const axios = require('axios');

const API_BASE = 'http://localhost:5000/api';

async function testCoursesCRUD() {
  console.log('🧪 Testing Complete Courses CRUD Integration...\n');
  ...
  try {
    ...
    // Test 2: Check if courses endpoint works
    ...
    const newCourse = {
      ...
      level: 'Beginner',
      price: 99.99,
      teacher_id: null // No tutor assigned initially
    };
    ...
    console.log('\n💡 Frontend should now work properly with backend!');
